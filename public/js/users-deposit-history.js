...
function doSearch() {
	...
	listTable.column(4).search(wallet_addr, false, false);
	listTable.column(6).search(tx_id, false, false);
    listTable.column(7).search(status, false, false);
    listTable.column(8).search(filterDates.join(':'), false, false).draw();
}
