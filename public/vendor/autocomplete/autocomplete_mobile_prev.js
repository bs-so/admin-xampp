...
function autocomplete_mobile_prev(inp, minLength = 10) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      $.ajax({
        url: BASE_URL + 'ajax/users/getMobileIds',
        type: 'POST',
        data: {
          'key':      val,
          'length' :  minLength,
